      ...
      <nav className="bg-[#18191A] px-4 lg:px-6 py-2.5 pt-5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center lg:order-2">
            <Link to="/projects">
              <span className="self-center mx-5 text-xl font-light whitespace-nowrap text-black">
                Projects
              </span>
            </Link>
            <Link to="/">
              ...
              <div>
                ...
                >
                  <div className="px-4 py-3 text-sm text-gray-900 dark:text-black">
                    <div>
                      {currentUser.length > 0 ? currentUser[0].name : 'Guest'}
                    </div>
                    <div className="font-medium truncate">
                      {currentUser.length > 0 ? currentUser[0].email : 'Guest'}
                    </div>
                  </div>
                  <ul

    ...
    return (
      <div className="cursor-pointer group flex h-full items-center justify-center rounded-3xl">
        <div className="space-y-2">
          <span className={`block h-1 w-7 origin-center rounded-full bg-white transition-transform ease-in-out duration-500 ${isHamburgerOpen ? 'translate-y-[0.55rem] rotate-45' : ' '}`}></span>
